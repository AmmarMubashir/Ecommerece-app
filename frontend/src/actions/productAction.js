...
// Update Product
export const updateProduct = (id, productData, jwt) => async (dispatch) => {
  try {
...
export const getAllReviews = (id, jwt) => async (dispatch) => {
  try {
...
export const deleteReviews = (reviewId, productId, jwt) => async (dispatch) => {
  try {
